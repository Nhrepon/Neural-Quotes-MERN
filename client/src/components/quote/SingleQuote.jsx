    ...
    <div className="col-sm-4">
        {
            quote && (
                <div className="card " ref={cardRef}>
                    <img className="card-img" src={backendUrl+img.filePath} alt={quote.quote} crossOrigin={"anonymous"}/>
                    <div className="card-body  d-flex align-items-center justify-content-center position-absolute text-center h-100"
                        ...
                        <div>
                            ...
                            <h2 className="fs-4 card-text text-light text-center mx-3">{quote.quote}</h2>
